...
import ShopDeliverySettingsComponent from '../components/ShopDeliverySettingsComponent';

const ContentDeliveryMarket = (props) => {
  ...
  return (
    <Layout {...props}>
      ...
      <PersonalPageViews.WrapperPage
        ...
        rightChildComponent={<ShopDeliverySettingsComponent content={content} />}
      ></PersonalPageViews.WrapperPage>
    </Layout>
  );
};

export default React.memo(ContentDeliveryMarket);
