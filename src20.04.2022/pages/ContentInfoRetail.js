...
import { GxTabGroup, GxButton, GxTextarea, GxTabPanel } from '@garpix/garpix-web-components-react';
import Button from '../Views/Button';
import Modal from '../Views/ModalCreator';
import ContentInfoRetailComponent from '../components/ContentInfoRetailComponent';

const ContentInfoRetail = (props) => {
  ...
  return (
    <Layout {...props}>
      ...
      <PersonalPageViews.WrapperPage
        ...
        rightChildComponent={<ContentInfoRetailComponent content={content} />}
      ></PersonalPageViews.WrapperPage>
    </Layout>
  );
};

export default React.memo(ContentInfoRetail);
