...
import ShopHomeSettingsComponent from '../components/ShopHomeSettingsComponent';

const ContentHomeShop = (props) => {
  ...
  return (
    <Layout {...props}>
      ...
      <PersonalPageViews.WrapperPage
        ...
        rightChildComponent={<ShopHomeSettingsComponent content={content} />}
      ></PersonalPageViews.WrapperPage>
    </Layout>
  );
};

export default React.memo(ContentHomeShop);
