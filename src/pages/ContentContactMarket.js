...
import ContentContactShopComponent from '../components/ContentContactShopComponent';

const ContentContactMarket = (props) => {
  ...
  return (
    <Layout {...props}>
      ...
      <PersonalPageViews.WrapperPage
        ...
        rightChildComponent={<ContentContactShopComponent content={content} />}
      ></PersonalPageViews.WrapperPage>
    </Layout>
  );
};

export default React.memo(ContentContactMarket);
